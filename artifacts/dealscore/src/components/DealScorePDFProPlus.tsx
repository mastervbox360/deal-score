      ...
      <Page size="A4" orientation="landscape" style={landscapePage}>
        ...
        <View style={{ flexDirection: 'row', gap: 0, flex: 1 }}>
          ...
          <View style={{ flex: 1, paddingRight: 16 }}>
            ...
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual rent divided by purchase price.</Text>
            ...
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual cash flow divided by total cash invested. Includes mortgage payment.</Text>

            <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Payback Period</Text>
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Years to recover invested capital from cash flow.</Text>

            <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Equity on Day One</Text>
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Immediate equity if property purchased below market value.</Text>
            ...
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly surplus after all costs including mortgage.</Text>
            ...
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Buffer between contracted rent and break-even rent.</Text>
          ...
          <View style={{ flex: 1, paddingLeft: 16 }}>
            ...
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total capital deployed into the deal.</Text>
