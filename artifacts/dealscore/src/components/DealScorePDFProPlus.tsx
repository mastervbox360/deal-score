          ...
          <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <View style={{ width: '58%', backgroundColor: '#ffffff', paddingTop: 36, paddingBottom: 36, paddingHorizontal: 32, flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              {props.currentScore !== 'Incomplete' && (
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: SCORE_TINT[props.currentScore] ?? 'rgba(107,114,128,0.09)', borderLeft: `4pt solid ${scoreColor}`, borderRadius: 3, paddingVertical: 10, paddingHorizontal: 14, marginBottom: 16 }}>
                  <View>
                    ...
                    <Text style={{ fontSize: 14, fontFamily: 'Helvetica-Bold', color: '#1B2B4B' }}>{VERDICT_LABELS[props.currentScore] ?? props.currentScore}</Text>
                  </View>
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5 }}>
                ...
                {props.tenure ? (
                  <View style={{ borderRadius: 10, border: props.tenure === 'Freehold' ? '0.5pt solid #2EC4B6' : '0.5pt solid #fbbf24', paddingVertical: 2, paddingHorizontal: 8, backgroundColor: props.tenure === 'Freehold' ? '#E1F5EE' : '#fef3c7' }}>
          ...
          <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <View style={{ width: '56%', paddingTop: 40, paddingBottom: 36, paddingLeft: 40, paddingRight: 24, flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <View style={{ alignItems: 'center' }}>
                ...
                <Text hyphenationCallback={(word: string) => [word]} style={{ fontSize: 22, fontFamily: 'Helvetica-Bold', color: coverBgText, textAlign: 'center', lineHeight: 1.3 }}>
                  {coverLine1}
                </Text>
                {coverLine2 ? (
            ...
            <View style={{ width: '44%', paddingTop: 40, paddingBottom: 36, paddingLeft: 24, paddingRight: 40, flexDirection: 'column', justifyContent: 'center', gap: 10 }}>
              ...
              {heroMetrics.map(({ label, value }) => (
                <View key={label} style={{ backgroundColor: '#ffffff', border: '0.5pt solid #d4dae8', borderLeft: `3pt solid ${structureColour}`, borderRadius: 4, paddingVertical: 8, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  <Text style={{ fontSize: 7, color: '#6B7280', textTransform: 'uppercase', letterSpacing: 0.4 }}>{label}</Text>
                  <Text style={{ fontSize: 15, fontFamily: 'Helvetica-Bold', color: '#1E2B3C' }}>{value}</Text>
                </View>
              ))}
              {props.currentScore !== 'Incomplete' && (
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: SCORE_TINT[props.currentScore] ?? 'rgba(107,114,128,0.09)', borderLeft: `4pt solid ${scoreColor}`, borderRadius: 3, paddingVertical: 8, paddingHorizontal: 12, marginTop: 4 }}>
                  <View>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: 'Helvetica-Bold', color: '#1B2B4B' }}>{VERDICT_LABELS[props.currentScore] ?? props.currentScore}</Text>
                  </View>
                  <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 2 }}>
                    <Text style={{ fontSize: 22, fontFamily: 'Helvetica-Bold', color: '#1B2B4B', lineHeight: 1 }}>{dealScoreOverall.toFixed(1)}</Text>
          ...
          <View style={{ flex: 1, flexDirection: 'column', position: 'relative' }}>
            ...
            <View style={{ flex: 1, paddingLeft: 44, paddingRight: 40, paddingTop: 32, paddingBottom: 40 }}>
              ...
              <View style={{ position: 'absolute', top: 0, left: 44, right: 40, bottom: 0, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Text hyphenationCallback={(word: string) => [word]} style={{ fontSize: 20, fontFamily: 'Helvetica-Bold', color: '#1A1A1A', textAlign: 'center', lineHeight: 1.3 }}>
                  {coverLine1}
                </Text>
                {coverLine2 ? (
                ...
                <View style={{ flexDirection: 'row', gap: 8, marginTop: 20, width: '90%' }}>
                  {heroMetrics.map(({ label, value }) => (
                    <View key={label} style={{ flex: 1, backgroundColor: '#ffffff', border: '0.5pt solid #d4dae8', borderTop: `2.5pt solid ${structureColour}`, borderRadius: 4, paddingVertical: 8, paddingHorizontal: 8 }}>
                      <Text style={{ fontSize: 15, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', lineHeight: 1, marginBottom: 3 }}>{value}</Text>
          ...
          <View style={{ flex: 1, paddingRight: 16 }}>
            ...
            {(props.dealType === 'BTL' || props.dealType === 'SOCIAL' || props.dealType === 'HMO') && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Annual rent as a percentage of purchase price.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Yield</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Annual income minus operating costs divided by purchase price. Mortgage excluded (UK standard).</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash-on-Cash ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Annual cash flow as a percentage of total cash invested. Includes mortgage payment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Payback Period</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Years to recover total cash invested from annual cash flow.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Equity on Day One</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Immediate equity created when a property is purchased below market value.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>BMV</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Below Market Value. The discount between purchase price and estimated market value.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total rental income before any deductions or void allowance.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Void Allowance</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Estimated cost of vacancy. A 5% void allowance equals approximately 2.5 weeks vacant per year.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Effective Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Gross rent after void allowance deducted.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Operating Income (NOI)</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Effective rent minus all operating costs, excluding mortgage.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Cash Flow</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly surplus after all costs including mortgage payment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Minimum rent required to cover all costs at the current mortgage rate.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Rent Headroom</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The buffer between contracted rent and break-even rent.</Text>
              </>
            )}
            ...
            {props.dealType === 'SA' && (
              <>
                ...
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>SA Income</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Gross Monthly Revenue</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total nightly income before platform fees and running costs. Calculated as: Nightly Rate × (Occupancy % ÷ 100) × 30.42 days.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Platform Fees</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Commission charged by booking platforms such as Airbnb and Booking.com.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Monthly Revenue</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Gross revenue after platform fees deducted.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Occupancy Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Percentage of nights in a month the property is occupied and generating income. DealScore default: 75%.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Cash Flow</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly surplus after all costs including mortgage payment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Minimum revenue required to cover all costs at the current mortgage rate.</Text>
              </>
            )}
            ...
            {props.dealType === 'BRRR' && (
              <>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>BRRR Gross Yield</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Yield calculated on post-refurb value (GDV), not purchase price.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Yield</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Annual income minus operating costs divided by post-refurb value. Mortgage excluded.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash-on-Cash ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Annual cash flow as a percentage of cash left in the deal after refinance.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Equity Created</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The uplift in property value above total cost in, realised through refurbishment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Money Out / Recycled</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>When the refinance loan exceeds total cost in. All capital returned plus a surplus. Cash-on-cash ROI is infinite.</Text>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Cash Flow</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly surplus after all costs including the refinance mortgage payment.</Text>
              </>
            )}

            {props.dealType === 'FLIP' && (
              <>
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>Project Returns</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Net profit as a percentage of total project cost.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Annualised ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total ROI scaled to a 12-month equivalent based on project length in months.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Profit on Cost</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Net profit expressed as a percentage of total costs. Benchmark: 18%+ with planning permission, 25%+ without.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Profit</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Sale proceeds minus all acquisition, build, and selling costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV (Gross Development Value)</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The target sale price or estimated open market value after works are complete.</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Project Costs</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total Cost In</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>All capital deployed: purchase price + tax + refurb + contingency + holding costs + other costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Holding Costs</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly financing or carrying costs during the project period.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Selling Costs</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Agent fees and legal costs on sale, expressed as a percentage of GDV.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Contingency</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>A percentage buffer added to refurb costs to absorb unexpected expenses. DealScore default: 10%.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Bridging Finance</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Short-term property-secured loan used to fund acquisition and/or refurbishment.</Text>
              </>
            )}

            {props.dealType === 'R2R' && (
              <>
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>R2R Income</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Monthly Spread</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The difference between sub-let income collected and rent paid to the landlord. The core R2R profit driver.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Gross Monthly Income</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total sub-let rent collected from all rooms at current occupancy.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Monthly Profit</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly income after rent to landlord, management fees, and running costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Annual Profit</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Net monthly profit multiplied by 12.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Setup Costs</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>One-off costs to establish the R2R agreement: furniture, deposits, compliance, and fit-out.</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Returns</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>ROI on Setup</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Annual profit as a percentage of total setup costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Payback Period</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Number of months to recover setup costs from monthly profit.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total Upfront</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>All capital needed to begin: setup costs + landlord deposit + first month rent.</Text>
              </>
            )}
          ...
          <View style={{ flex: 1, paddingLeft: 16 }}>
            ...
            {(props.dealType === 'BTL' || props.dealType === 'SOCIAL' || props.dealType === 'HMO' || props.dealType === 'SA') && (
              <>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The minimum rent or revenue required to cover all costs at the current mortgage rate. Cash flow is exactly zero at this level.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Stress Test</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>{props.dealType === 'SA' ? 'Analysis of deal performance under a higher mortgage rate (+1.5%) and lower revenue (-10%), applied independently.' : 'Analysis of deal performance under a higher mortgage rate (+1.5%) and lower rent (-10%), applied independently.'}</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The mortgage rate at which monthly cash flow reaches exactly zero.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Sensitivity Analysis</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>{props.dealType === 'SA' ? 'Shows the impact on cash flow and ROI of a 10% revenue reduction and a 1.5% rate increase independently.' : 'Shows the impact on cash flow and ROI of a 10% rent reduction and a 1.5% rate increase independently.'}</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 4, marginTop: 10 }}>Finance &amp; Structure</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Interest-Only Mortgage</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly payment covers interest only. Capital balance remains unchanged throughout the term.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Repayment Mortgage</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly payment covers both interest and capital. Balance reduces to zero over the term.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>LTV</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Loan to Value. Mortgage amount expressed as a percentage of property value.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total capital deployed: deposit + tax + refurb + other costs.</Text>
              </>
            )}

            {props.dealType === 'HMO' && (
              <>
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>HMO</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Profit Per Room</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Monthly cash flow divided equally across all rooms. Key HMO efficiency metric.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>HMO Licence</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Required local authority licence for larger HMOs. Cost is a one-off acquisition cost, not monthly.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Gross Monthly Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total room rental income across all rooms at current occupancy rate.</Text>
              </>
            )}

            {props.dealType === 'BRRR' && (
              <>
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>BRRR Structure</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV (Gross Development Value)</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The estimated market value of the property after refurbishment is complete.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Refinance Loan</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Capital released by remortgaging against the post-refurb value at a set LTV.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Left In</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Capital remaining in the deal after subtracting the refinance loan from total cost in.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total Cost In</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>All capital deployed into the BRRR: purchase price + tax + refurb + bridging interest + other costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Bridging Finance</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Short-term property-secured loan used to fund acquisition and refurbishment before refinancing.</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Stress Testing &amp; Resilience</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Stress Test</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Analysis of deal performance under a higher mortgage rate (+1.5%) and lower rent (-10%), applied independently.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The mortgage rate at which monthly cash flow reaches exactly zero.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Sensitivity Analysis</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Shows the impact on cash flow and ROI of a 10% rent reduction and a 1.5% rate increase independently.</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Tax &amp; Structure</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>LTV</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Loan to Value. Mortgage amount expressed as a percentage of property value.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>LTT / SDLT</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Land Transaction Tax (Wales) or Stamp Duty Land Tax (England &amp; NI).</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total capital deployed into the deal before refinance.</Text>
              </>
            )}

            {props.dealType === 'FLIP' && (
              <>
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>Stress &amp; Sensitivity</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cost Overrun Risk</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Impact on profit if build costs increase beyond budget. A 10% overrun on a £30k refurb reduces profit by £3,000.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV Sensitivity</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Impact on profit if the achieved sale price is lower than the GDV estimate.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even GDV</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The minimum sale price at which the project still makes a profit.</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Tax &amp; Structure</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>LTT / SDLT</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Land Transaction Tax (Wales) or Stamp Duty Land Tax (England &amp; NI). Government purchase tax on property transactions.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total capital deployed into the project.</Text>
              </>
            )}

            {props.dealType === 'R2R' && (
              <>
                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>Agreement &amp; Risk</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Landlord Agreement</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>The lease or licence between the sourcer and the property owner permitting sub-letting. Term, break clauses, and subletting rights must be clearly documented.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Subletting</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Renting out a property or individual rooms that you yourself rent from the owner.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Occupancy Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Percentage of rooms occupied and generating income. DealScore default: 90%.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Management Fees</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Platform or agent commission charged on gross income collected.</Text>

                <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Structure</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Total setup costs deployed to establish the agreement.</Text>
              </>
            )}

            {/* Universal terms — all strategies */}
            <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 4, marginTop: 10 }}>Tax, Legal &amp; Verdicts</Text>

            <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Sourcing Fee</Text>
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Fee payable to the deal sourcer on legal completion.</Text>
            ...
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Weighted composite score from 1 to 10 across six dimensions: Gross Yield, Net Cash Flow, Capital Growth Potential, Tenant Demand, Deal Structure, and Risk Profile.</Text>

            <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Recommended</Text>
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Deal meets or exceeds all key thresholds for this strategy. Strong candidate for investor presentation.</Text>

            <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Review</Text>
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Deal partially meets thresholds. Worth progressing with negotiation or cost review.</Text>

            <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Avoid</Text>
            <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Deal falls below minimum thresholds. Not recommended at current numbers.</Text>
        ...
        {(props.dealType === 'BTL' || props.dealType === 'HMO' || props.dealType === 'SA' || props.dealType === 'SOCIAL' || props.dealType === 'BRRR') ? (
          <View style={{ flexDirection: 'row', gap: 0, flex: 1 }}>
            <View style={{ flex: 1, paddingRight: 16 }}>
              ...
              {props.dealType !== 'BRRR' ? (
                ...
                <>
                  ...
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Post-Refurb Value - Total Cost In</Text>

                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>BRRR Gross Yield</Text>
                  <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Yield calculated on GDV.</Text>
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Annual Rent ÷ Post-Refurb Value) × 100</Text>
                </>
              )}

              {props.dealType === 'SA' && (
                <>
                  <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>SA Revenue</Text>
                  ...
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Nightly Rate × (Occupancy % ÷ 100) × 30.42</Text>

                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Platform Fees</Text>
                  <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Commission deducted from gross revenue.</Text>
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Gross Monthly Revenue × Platform Fee %</Text>

                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Monthly Revenue</Text>
                  <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Revenue after platform fees.</Text>
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Gross Monthly Revenue - Platform Fees</Text>
                </>
              )}
              ...
              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Operating Income</Text>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Effective Rent - Operating Costs</Text>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Net Operating Income - Mortgage Payment</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Monthly Mortgage (Interest-Only)</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Monthly interest payment.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Mortgage Amount × Annual Rate %) ÷ 12</Text>
            </View>
            ...
            <View style={{ flex: 1, paddingLeft: 16 }}>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Operating Costs + Mortgage Payment</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Rent Headroom</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Buffer before deal becomes cash-flow negative.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Contracted Rent - Break-Even Rent</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rate</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Mortgage rate at which cash flow reaches zero.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Solved from: Rent = Operating Costs + (Mortgage Amount × Rate ÷ 12)</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Sensitivity Analysis</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 4 }}>Performance under rent -10% and rate +1.5% applied independently. See sensitivity table in report.</Text>

              <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Capital &amp; Structure</Text>

              {props.dealType === 'BRRR' ? (
                <>
                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                  <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>All capital deployed before refinance.</Text>
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Purchase Price + Tax + Refurb + Bridging Interest + Other Costs</Text>
                </>
              ) : (
                <>
                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Mortgage Amount ÷ Property Value) × 100</Text>

              {props.dealType === 'BRRR' && (
                <>
                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Refinance Loan</Text>
                  <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Capital released on refinance.</Text>
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Post-Refurb Value × (Refinance % ÷ 100)</Text>

                  <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Left In</Text>
                  <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Capital remaining after refinance.</Text>
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Total Cost In - Refinance Loan</Text>
                </>
              )}
              ...
              {props.dealType === 'HMO' && (
                <>
                  ...
                  <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Monthly Cash Flow ÷ Number of Rooms</Text>
          ...
          <View style={{ flexDirection: 'row', gap: 0, flex: 1 }}>
            <View style={{ flex: 1, paddingRight: 16 }}>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Net Profit ÷ Total Cost In) × 100</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Annualised ROI</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>ROI scaled to a 12-month equivalent.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Total ROI ÷ Project Length in months) × 12</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Profit on Cost</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Net profit as a percentage of total project cost.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Net Profit ÷ Total Cost) × 100</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Profit</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Sale proceeds minus all costs.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Expected Sale Price - Total Cost - Selling Costs</Text>

              <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6, marginTop: 12 }}>Project Costs</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total Cost In</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>All capital deployed into the project.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Purchase Price + Tax + Refurb + Holding Costs + Other Costs</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Holding Costs</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Finance costs during the project period.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Monthly Holding Cost × Project Length (months)</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Selling Costs</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Agent and legal fees on sale.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Expected Sale Price × Selling Costs %</Text>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Refurb Cost × Contingency %</Text>
            </View>
            ...
            <View style={{ flex: 1, paddingLeft: 16 }}>
              ...
              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cost Overrun Scenario</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Profit impact if costs increase by 10%.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Net Profit - (Total Cost × 10%)</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV Sensitivity</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Profit impact of a 5% lower sale price.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Net Profit - (Expected Sale Price × 5%)</Text>
          ...
          <View style={{ flexDirection: 'row', gap: 0, flex: 1 }}>
            <View style={{ flex: 1, paddingRight: 16 }}>
              <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>Income &amp; Spread</Text>
              ...
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Gross Monthly Income - Monthly Rent to Landlord</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Monthly Profit</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Profit after all costs.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Gross Monthly Income - Rent to Landlord - Management Fees - Running Costs</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Annual Profit</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Net monthly profit scaled annually.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Net Monthly Profit × 12</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Management Fees</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Platform or agent commission on gross income.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Gross Monthly Income × Management Fee %</Text>
            </View>

            <View style={{ width: 0.5, backgroundColor: '#E5E7EB', marginHorizontal: 0 }} />

            <View style={{ flex: 1, paddingLeft: 16 }}>
              <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Bold', color: structureColour, textTransform: 'uppercase', letterSpacing: 0.8, paddingBottom: 3, borderBottom: `0.5pt solid ${structureColour}`, marginBottom: 6 }}>Returns &amp; Recovery</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>ROI on Setup</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Annual profit as a percentage of setup costs.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>(Annual Profit ÷ Setup Costs) × 100</Text>

              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Payback Period</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 1 }}>Months to recover setup costs from monthly profit.</Text>
              <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 6 }}>Setup Costs ÷ Net Monthly Profit</Text>
