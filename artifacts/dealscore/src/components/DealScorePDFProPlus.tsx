          ...
          <View style={{ flex: 1, paddingRight: 16 }}>
            ...
            {(props.dealType === 'BTL' || props.dealType === 'SOCIAL' || props.dealType === 'HMO') && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual rent as a percentage of purchase price.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Yield</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual income minus operating costs divided by purchase price. Mortgage excluded (UK standard).</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash-on-Cash ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual cash flow as a percentage of total cash invested. Includes mortgage payment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Payback Period</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Years to recover total cash invested from annual cash flow.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Equity on Day One</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Immediate equity created when a property is purchased below market value.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Estimated cost of vacancy. A 5% void allowance equals approximately 2.5 weeks vacant per year.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Effective Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Gross rent after void allowance deducted.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly surplus after all costs including mortgage payment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Minimum rent required to cover all costs at the current mortgage rate.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Rent Headroom</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The buffer between contracted rent and break-even rent.</Text>
              </>
            )}
            ...
            {props.dealType === 'SA' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total nightly income before platform fees and running costs. Calculated as: Nightly Rate × (Occupancy % ÷ 100) × 30.42 days.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Platform Fees</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Commission charged by booking platforms such as Airbnb and Booking.com.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Monthly Revenue</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Gross revenue after platform fees deducted.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Occupancy Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Percentage of nights in a month the property is occupied and generating income. DealScore default: 75%.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Cash Flow</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly surplus after all costs including mortgage payment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Minimum revenue required to cover all costs at the current mortgage rate.</Text>
              </>
            )}
            ...
            {props.dealType === 'BRRR' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Yield calculated on post-refurb value (GDV), not purchase price.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Yield</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual income minus operating costs divided by post-refurb value. Mortgage excluded.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash-on-Cash ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual cash flow as a percentage of cash left in the deal after refinance.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Equity Created</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The uplift in property value above total cost in, realised through refurbishment.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Money Out / Recycled</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>When the refinance loan exceeds total cost in. All capital returned plus a surplus. Cash-on-cash ROI is infinite.</Text>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Cash Flow</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly surplus after all costs including the refinance mortgage payment.</Text>
              </>
            )}
            ...
            {props.dealType === 'FLIP' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Net profit as a percentage of total project cost.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Annualised ROI</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total ROI scaled to a 12-month equivalent based on project length in months.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Profit on Cost</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Net profit expressed as a percentage of total costs. Benchmark: 18%+ with planning permission, 25%+ without.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Profit</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Sale proceeds minus all acquisition, build, and selling costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV (Gross Development Value)</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The target sale price or estimated open market value after works are complete.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>All capital deployed: purchase price + tax + refurb + contingency + holding costs + other costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Holding Costs</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly financing or carrying costs during the project period.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Selling Costs</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Agent fees and legal costs on sale, expressed as a percentage of GDV.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Contingency</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>A percentage buffer added to refurb costs to absorb unexpected expenses. DealScore default: 10%.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Bridging Finance</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Short-term property-secured loan used to fund acquisition and/or refurbishment.</Text>
              </>
            )}
            ...
            {props.dealType === 'R2R' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The difference between sub-let income collected and rent paid to the landlord. The core R2R profit driver.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Gross Monthly Income</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total sub-let rent collected from all rooms at current occupancy.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Net Monthly Profit</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly income after rent to landlord, management fees, and running costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Annual Profit</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Net monthly profit multiplied by 12.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Setup Costs</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>One-off costs to establish the R2R agreement: furniture, deposits, compliance, and fit-out.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Annual profit as a percentage of total setup costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Payback Period</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Number of months to recover setup costs from monthly profit.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total Upfront</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>All capital needed to begin: setup costs + landlord deposit + first month rent.</Text>
              </>
            )}
          ...
          <View style={{ flex: 1, paddingLeft: 16 }}>
            ...
            {(props.dealType === 'BTL' || props.dealType === 'SOCIAL' || props.dealType === 'HMO' || props.dealType === 'SA') && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>{props.dealType === 'SA' ? 'Analysis of deal performance under a higher mortgage rate (+1.5%) and lower revenue (-10%), applied independently.' : 'Analysis of deal performance under a higher mortgage rate (+1.5%) and lower rent (-10%), applied independently.'}</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The mortgage rate at which monthly cash flow reaches exactly zero.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly payment covers both interest and capital. Balance reduces to zero over the term.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>LTV</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Loan to Value. Mortgage amount expressed as a percentage of property value.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total capital deployed: deposit + tax + refurb + other costs.</Text>
              </>
            )}
            ...
            {props.dealType === 'HMO' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Monthly cash flow divided equally across all rooms. Key HMO efficiency metric.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>HMO Licence</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Required local authority licence for larger HMOs. Cost is a one-off acquisition cost, not monthly.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Gross Monthly Rent</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total room rental income across all rooms at current occupancy rate.</Text>
              </>
            )}
            ...
            {props.dealType === 'BRRR' && (
              <>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV (Gross Development Value)</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The estimated market value of the property after refurbishment is complete.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Refinance Loan</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Capital released by remortgaging against the post-refurb value at a set LTV.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Left In</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Capital remaining in the deal after subtracting the refinance loan from total cost in.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Total Cost In</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>All capital deployed into the BRRR: purchase price + tax + refurb + bridging interest + other costs.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Bridging Finance</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Short-term property-secured loan used to fund acquisition and refurbishment before refinancing.</Text>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Stress Test</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Analysis of deal performance under a higher mortgage rate (+1.5%) and lower rent (-10%), applied independently.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The mortgage rate at which monthly cash flow reaches exactly zero.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Sensitivity Analysis</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Shows the impact on cash flow and ROI of a 10% rent reduction and a 1.5% rate increase independently.</Text>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Land Transaction Tax (Wales) or Stamp Duty Land Tax (England &amp; NI).</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total capital deployed into the deal before refinance.</Text>
              </>
            )}
            ...
            {props.dealType === 'FLIP' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Impact on profit if build costs increase beyond budget. A 10% overrun on a £30k refurb reduces profit by £3,000.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>GDV Sensitivity</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Impact on profit if the achieved sale price is lower than the GDV estimate.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Break-Even GDV</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The minimum sale price at which the project still makes a profit.</Text>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total capital deployed into the project.</Text>
              </>
            )}
            ...
            {props.dealType === 'R2R' && (
              <>
                ...
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>The lease or licence between the sourcer and the property owner permitting sub-letting. Term, break clauses, and subletting rights must be clearly documented.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Subletting</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Renting out a property or individual rooms that you yourself rent from the owner.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Occupancy Rate</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Percentage of rooms occupied and generating income. DealScore default: 90%.</Text>

                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Management Fees</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Platform or agent commission charged on gross income collected.</Text>
                ...
                <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Cash Invested</Text>
                <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Total setup costs deployed to establish the agreement.</Text>
              </>
            )}
        ...
        {(props.dealType === 'BTL' || props.dealType === 'HMO' || props.dealType === 'SA' || props.dealType === 'SOCIAL' || props.dealType === 'BRRR') ? (
          <View style={{ flexDirection: 'row', gap: 0, flex: 1 }}>
            ...
            <View style={{ flex: 1, paddingLeft: 16 }}>
              ...
              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Sensitivity Analysis</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Performance under rent -10% and rate +1.5% applied independently. See sensitivity table in report.</Text>
              ...
              <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 1 }}>Overall Score</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 6 }}>Weighted composite from 1 to 10 across six dimensions: Gross Yield, Net Cash Flow, Capital Growth Potential, Tenant Demand, Deal Structure, and Risk Profile</Text>
