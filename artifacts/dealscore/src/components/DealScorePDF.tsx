...
export interface DealScorePDFProps {
  ...
  flipInputs: { holdingCostsPerMonth: number; projectLengthMonths: number; expectedSalePrice: number; sellingCostsPercent: number; financingMethod?: string; contingencyPercent?: number };
  flipPurchaseFinancingCost?: number;
  flipRefurbFinancingCost?: number;
  flipTotalFinancingCost?: number;
  flipRefurbWithContingency?: number;
            ...
            <View style={{ backgroundColor: tintBg, borderRadius: 4, paddingVertical: 10, paddingHorizontal: 14, borderTop: `2pt solid ${structureColour}` }}>
              <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                {[
                  ...
                  <View key={i} style={{ width: '50%', flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 3, paddingRight: 10, borderBottom: `0.5pt solid ${tintBorder}` }}>
                    <Text style={{ fontSize: 8, color: tintText }}>{lbl}</Text>
        ...
        {(props.dealType === 'BTL' || props.dealType === 'HMO' || props.dealType === 'SA' || props.dealType === 'SOCIAL' || props.dealType === 'BRRR') ? (
          <View style={{ flexDirection: 'row', gap: 0 }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              ...
              <Text style={{ fontSize: 8.5, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 0 }}>Mortgage Amount</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 2 }}>Loan amount based on deposit percentage.</Text>
              <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 5 }}>Purchase Price × (1 − Deposit % ÷ 100)</Text>
            ...
            <View style={{ flex: 1, paddingLeft: 12 }}>
              ...
              <Text style={{ fontSize: 8.5, fontFamily: 'Helvetica-Bold', color: '#1E2B3C', marginBottom: 0 }}>Refurb Bridging Interest</Text>
              <Text style={{ fontSize: 8, color: '#6B7280', lineHeight: 1.45, marginBottom: 2 }}>Monthly interest charged on the bridging loan during the refurbishment term.</Text>
              <Text style={{ fontSize: 7.5, fontFamily: 'Helvetica-Oblique', color: '#3B82F6', marginBottom: 5 }}>Bridging Amount × Monthly Rate % × Term (months)</Text>
