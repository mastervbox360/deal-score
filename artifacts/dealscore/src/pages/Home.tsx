              ...
              <div className="flex items-center">
                ...
                {showPurchasePrice && (<>
                  ...
                  <div className="hidden lg:flex flex-col leading-none px-3">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">Purchase Price</span>
                ...
                {dealType === 'FLIP' && flipInputs.expectedSalePrice > 0 && (<>
                  <div className="h-5 w-px bg-border/60 mx-1 shrink-0" />
                  <div className="hidden lg:flex flex-col leading-none px-3">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">GDV</span>
                ...
                {dealType === 'R2R' && r2rInputs.setupCosts > 0 && (<>
                  <div className="h-5 w-px bg-border/60 mx-1 shrink-0" />
                  <div className="hidden lg:flex flex-col leading-none px-3">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">Setup Costs</span>
                ...
                {!incomplete && (<>
                  <div className="h-5 w-px bg-border/60 mx-1 shrink-0" />
                  <div className="hidden lg:flex flex-col leading-none px-3">
                    <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">{keyMetricLabel}</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">What I Commit</span>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Invested<InfoIcon id="g1-btl-cash" text="Total cash required to complete this purchase: deposit + stamp duty + refurb costs + other costs. This is your total capital at risk." /></span>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">{showAnnual ? 'Annual figures' : 'Monthly figures'}</span>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Mortgage<InfoIcon id="g2-btl-mort" text="Monthly mortgage payment based on your rate, term and repayment type." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Operating Costs<InfoIcon id="g2-btl-ops" text="Total monthly running costs: management fees + maintenance reserve + buildings insurance + void allowance. Includes service charge and ground rent where applicable." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Flow<InfoIcon id="g2-btl-cf" text="Net monthly income after all costs and mortgage payments. This is what lands in your account." /></span>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">Returns</span>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">CoC ROI<InfoIcon id="g3-btl-coc" text="Cash-on-Cash ROI: annual cash flow ÷ cash invested × 100. The most accurate measure of return on leveraged property. Benchmark: 5%+ strong, 3%+ average." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(btlResults.cashOnCashROI)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Gross Yield<InfoIcon id="g3-btl-gy" text="Annual rental income ÷ purchase price × 100. Used to compare properties regardless of financing. Benchmark: 5%+ for BTL." /></span>
                ...
                {missingFields.length === 0 && dealType === 'HMO' && (
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Invested<InfoIcon id="g1-hmo-cash" text="Total cash required: deposit + stamp duty + refurb + HMO licence + other costs." /></span>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Mortgage<InfoIcon id="g2-hmo-mort" text="Monthly mortgage payment." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Operating Costs<InfoIcon id="g2-hmo-ops" text="Total monthly running costs: management fees + maintenance reserve + buildings insurance + void allowance." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Flow<InfoIcon id="g2-hmo-cf" text="Net monthly income after all costs and mortgage." /></span>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">CoC ROI<InfoIcon id="g3-hmo-coc" text="Annual cash flow ÷ cash invested × 100. Benchmark: 12%+ strong for HMO." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(hmoResults.cashOnCashROI)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Gross Yield<InfoIcon id="g3-hmo-gy" text="Annual room income ÷ purchase price × 100. Benchmark: 7%+ for HMO, 10%+ strong." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(hmoResults.grossYield)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Profit/Room<InfoIcon id="g3-hmo-ppr" text="Monthly cash flow divided by number of rooms. Benchmark: £100–£150+ per room minimum. Useful for comparing HMOs of different sizes." /></span>
                ...
                {missingFields.length === 0 && dealType === 'FLIP' && (
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Total Cost In<InfoIcon id="g1-flip-cost" text="All costs to acquire and refurbish: purchase price + stamp duty + refurb + bridging interest + other costs." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatCurrency(flipResults.totalCost)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Net Profit<InfoIcon id="g1-flip-profit" text="Expected sale price minus all costs. This is your take-home from the deal." /></span>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start">{showAnnual ? 'Total figures' : 'Per month figures'}</span>
                        <div className="flex gap-1">
                          <button type="button" onClick={() => setShowAnnual(false)} className={`text-[9px] px-2 py-0.5 rounded-md font-medium transition-colors ${!showAnnual ? 'bg-[#1B3A6B] text-white' : 'bg-slate-100 text-muted-foreground hover:bg-slate-200'}`}>Monthly</button>
                          <button type="button" onClick={() => setShowAnnual(true)} className={`text-[9px] px-2 py-0.5 rounded-md font-medium transition-colors ${showAnnual ? 'bg-[#1B3A6B] text-white' : 'bg-slate-100 text-muted-foreground hover:bg-slate-200'}`}>Annual</button>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Holding Costs<InfoIcon id="g2-flip-hold" text="Monthly costs during the project: insurance, council tax, utilities, finance charges." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Profit<InfoIcon id="g2-flip-prof" text="Net profit divided by project length in months. Switch to Total to see the full deal profit." /></span>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Total ROI<InfoIcon id="g3-flip-roi" text="Net profit ÷ total cost × 100. Benchmark: 8%+ acceptable, 12%+ strong." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(flipResults.roi)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Ann. ROI<InfoIcon id="g3-flip-ann" text="Total ROI annualised based on project length. Allows comparison with buy-and-hold strategies." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(flipResults.annualisedROI)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Profit on Cost<InfoIcon id="g3-flip-poc" text="Net profit ÷ total cost. Developer benchmark: 18%+ with planning permission, 25%+ without planning." /></span>
                ...
                {missingFields.length === 0 && dealType === 'SA' && (
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Invested<InfoIcon id="g1-sa-cash" text="Total cash required: deposit + stamp duty + refurb + other costs." /></span>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Mortgage<InfoIcon id="g2-sa-mort" text="Monthly mortgage payment." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Operating Costs<InfoIcon id="g2-sa-ops" text="Total monthly running costs: management fees + maintenance reserve + buildings insurance + platform fees (Airbnb/Booking.com)." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Flow<InfoIcon id="g2-sa-cf" text="Net monthly income after all costs and mortgage." /></span>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">CoC ROI<InfoIcon id="g3-sa-coc" text="Annual cash flow ÷ cash invested × 100. Benchmark: 10%+ strong for SA." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(saResults.cashOnCashROI)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Gross Yield<InfoIcon id="g3-sa-gy" text="Annual gross revenue ÷ purchase price × 100." /></span>
                ...
                {missingFields.length === 0 && dealType === 'BRRR' && (
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Invested<InfoIcon id="g1-brrr-cash" text="Total cash before refinance: purchase + stamp duty + refurb + bridging interest + other costs." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatCurrency(brrrResults.totalCostIn)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Left In<InfoIcon id="g1-brrr-left" text="Cash remaining in deal after refinance. Target: as close to £0 as possible. £0 means capital fully recycled." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Refinance Loan<InfoIcon id="g1-brrr-refi" text="The new long-term mortgage taken out after refinancing. Calculated as refinance % × post-refurb value." /></span>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Mortgage<InfoIcon id="g2-brrr-mort" text="Monthly refinance mortgage payment on the new long-term mortgage." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Operating Costs<InfoIcon id="g2-brrr-ops" text="Total monthly running costs: management fees + maintenance reserve + buildings insurance + void allowance." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Flow<InfoIcon id="g2-brrr-cf" text="Net monthly income after all costs and refinance mortgage." /></span>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">CoC ROI<InfoIcon id="g3-brrr-coc" text="Annual cash flow ÷ cash left in deal × 100. The lower the cash left in, the higher this number. Infinite when capital is fully recycled." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Gross Yield<InfoIcon id="g3-brrr-gy" text="Annual rent ÷ post-refurb value × 100." /></span>
                ...
                {missingFields.length === 0 && dealType === 'R2R' && (
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Setup Costs<InfoIcon id="g1-r2r-setup" text="One-off costs to set up the R2R: furniture, furnishings, admin and legal fees." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatCurrency(r2rInputs.setupCosts)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Total Upfront<InfoIcon id="g1-r2r-upfront" text={`True total cash required to start: setup costs + landlord deposit (${r2rLandlordDepositMonths} month${r2rLandlordDepositMonths !== 1 ? 's' : ''}) + first month rent paid before income begins.`} /></span>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Landlord Rent<InfoIcon id="g2-r2r-rent" text="Monthly rent paid to the property owner under the R2R agreement. Your primary fixed cost." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Running Costs<InfoIcon id="g2-r2r-run" text="Monthly running costs: management/platform fees + monthly expenses." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Profit<InfoIcon id="g2-r2r-prof" text="Net monthly profit after landlord rent and all running costs." /></span>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">ROI on Setup<InfoIcon id="g3-r2r-roi" text="Annual profit ÷ setup costs × 100. Benchmark: 50%+ strong, 25%+ average." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(r2rResults.roi)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Monthly Spread<InfoIcon id="g3-r2r-spread" text="Gross room income minus landlord rent — your gross margin before other costs. Benchmark: £300+ comfortable, £500+ strong." /></span>
                ...
                {missingFields.length === 0 && dealType === 'SOCIAL' && (
                  <div className="space-y-3">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Invested<InfoIcon id="g1-soc-cash" text="Total cash required: deposit + stamp duty + refurb + other costs." /></span>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Mortgage<InfoIcon id="g2-soc-mort" text="Monthly mortgage payment." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Operating Costs<InfoIcon id="g2-soc-ops" text="Total monthly running costs. Typically lower for social housing as the housing provider manages day-to-day maintenance." /></span>
                        ...
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Cash Flow<InfoIcon id="g2-soc-cf" text="Net monthly income after all costs and mortgage." /></span>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">CoC ROI<InfoIcon id="g3-soc-coc" text="Annual cash flow ÷ cash invested × 100. Social housing trades lower return for long-term stability and zero void risk. Benchmark: 3%+ average, 5%+ strong." /></span>
                          <span className="text-lg font-bold" style={{ color: '#1B3A6B' }}>{formatPercent(socialResults.cashOnCashROI)}</span>
                        </div>
                        <div className="bg-slate-50 rounded-xl border border-border/60 p-3 flex flex-col justify-between min-h-[72px]">
                          <span className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground min-h-[24px] flex items-start gap-1">Gross Yield<InfoIcon id="g3-soc-gy" text="Annual guaranteed lease income ÷ purchase price × 100." /></span>
